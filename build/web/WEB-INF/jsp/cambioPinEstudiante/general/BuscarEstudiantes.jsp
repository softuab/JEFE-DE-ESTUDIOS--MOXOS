    ...
    <body> 
        ...
        <section class="lockscreen-content">
            <div class="lock-box"><img class="rounded-circle user-image" src="${simagen}">
                ...
                <p class="text-center text-muted">Buscar Estudiante</p>
                <form method="post" action='<c:url value="/cambioPinEstudianteGeneral/listarEstudiantes.fautapo"/>'>
                    ...
                    <div class="input-group">
                        ...
                        <select class="custom-select" name="tipobusqueda" id="tipobusqueda">
                            <option value="ru">Registro Universitario(RU)</option>
                            <option value="ci">Cedula de Identidad</option>
                            <option value="nombre">Nombre Completo</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <input class="form-control" type=text name="busqueda" placeholder="Buscar Estudiante" autofocus>
                    </div>
