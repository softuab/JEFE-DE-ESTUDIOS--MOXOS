...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-dashboard"></i><i class="far fa-address-card"></i>&nbsp;Administraci&oacute;n de Grupos - Agregando</h1>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form method="post" modelAttribute="model"  action="${pageContext.request.contextPath}/grupos/registrarNuevo.fautapo">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <form:select path="id_materia"  data-url="${pageContext.request.contextPath}/ListarMtrGruposNoAsignadosAjax.fautapo" cssClass="form-control"  >
                                        <option value=""  disabled selected>Seleccionar materia</option>
                                        <form:options items="${lMaterias}" itemValue="id_materia" itemLabel="materia"/>
                                    </form:select>
                                    <form:errors path="id_materia" cssClass="invalid"/>
                                </div>
                            </div>
