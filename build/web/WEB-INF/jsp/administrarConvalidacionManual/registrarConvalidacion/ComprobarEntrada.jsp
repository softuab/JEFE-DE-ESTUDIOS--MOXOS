...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-dashboard"></i><i class="far fa-address-card"></i>&nbsp;Convalidaci&oacute;n Manual</h1>
                    <p>${usuario}</p> 
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/convalidacionManual/seleccionarprograma.fautapo">
                            ...
                            <div class="form-group row">
                                <c:choose>
                                    ...
                                    <c:when test="${cliente.id_departamento > 0}"><label class="control-label col-md-3">Departamento:</label><div class="col-md-9"><c:out value="${acceso.acceso}"/></div></c:when>
                                </c:choose> 
                            </div>
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        <button class="btn btn-primary" type='submit' value='Siguiente'><i class="fa fa-fw fa-lg fa-check-circle"></i>Siguiente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href='<c:url value="/convalidacionManual/entrada.fautapo"/>'><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form:form>
