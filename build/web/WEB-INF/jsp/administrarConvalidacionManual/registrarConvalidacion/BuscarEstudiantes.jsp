    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/convalidacionManual/listarPlanEstudiante.fautapo">
                        ...
                        <form method="post" id="frmsalir" modelAttribute="model" action="${pageContext.request.contextPath}/convalidacionManualVolver/comprobarEntrada.fautapo">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                            <input type="hidden" name="id_programa" value="<c:out value='${id_programa}'/>">
                            <input type="hidden" name="gestion" value="<c:out value='${gestion}'/>">
                            <input type="hidden" name="periodo" value="<c:out value='${periodo}'/>">
