...
<html lang="es">
    ...
    <body class="app sidear-mini rtl">
                    ...
                    <div class="tile">
                        <div class="Card-Informacion">
                            <div class="card border-secondary mb-3" style="max-width: 18rem; ">
                                <div class="card-header text-center"><i class="fas fa-exclamation-triangle"></i>&nbsp;&nbsp;AVISO</div>
                                <div class="card-body text-secondary">
                                    <p class="card-text text-center">
                                        <c:out value="${mensaje}"/><br><br>
                                        <a class="btn btn-primary text-center" href="#" id="btnsalir"><strong>Volver</strong></a>
                                    </p>
                                    <form method="post" id="frmsalir" modelAttribute="model" action="${pageContext.request.contextPath}/listarDocentesAsignadosMaterias.fautapo"> 
