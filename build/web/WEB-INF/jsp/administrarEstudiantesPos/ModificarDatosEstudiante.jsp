...
<br>
<form name="fvolver" action="<c:url value='/est_personaspos/entrada.fautapo'/>" method="post">
...
<br>
<form  name=forma action="<c:url value="/est_personaspos/registrarModificarPrsEstudiante.fautapo"/>" method="POST">
    ...
    <tr>
	  ...
	  <tr> 
	   ...
	   <td class="etiqueta3">Universidad<br> 
		 <input type="text"  name="nro_seguro_medico"  title="Nro. Seguro Medico" size="60"  value="<c:out value='${datosPrs.nro_seguro_medico}'/>"/>
	   </td>
	   <td></td>
	  <tr>
	  ...
	  <table>
	  <tr>
            <td class="etiqueta4">R.U. ::</td>
            <td><c:out value="${datosEst.id_estudiante}"/> </td>
          </tr>
	  <tr>
            <td class="etiqueta4">Fecha de Inscripci&oacute;n ::</td>
            <td><fmt:formatDate value="${datosEst.fec_inscripcion}" pattern="${formatoFecha}"/>
