                        ...
                        <section class="invoice">
                            ...
                            <div class="row mb-4">
                                <div class="col text-center">
                                    <h3 style="text-align: center;">RETIRO DE MATERIAS - ADICION DE MATERIAS</h3>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p><strong>Usuario: &nbsp;</strong> [<c:out value="${cliente.nombres}"/>]&nbsp; <strong><fmt:formatDate value="${now}" pattern="${formatoFecha}  ${formatoHora}"/> &nbsp;</strong> </p>
                                </div>
                            </div>
                            <div class="row d-print-none mt-2">
                                <form  name="fvolver" method='post' action="<c:url value='/retiroAdicionMateriasJefe/comprobarEntrada.fautapo'/>">
                                    <input type="hidden" name="gestion"          value="<c:out value='${gestion}'/>" >
                                    <input type="hidden" name="periodo"          value="<c:out value='${periodo}'/>" >
                                    <input type=hidden name="id_tipo_evaluacion" value=<c:out value="${id_tipo_evaluacion}"/> >
                                    <input type=hidden name="id_programa"        value=<c:out value="${id_programa}"/> >
                                </form>
                                <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print();"><i class="fa fa-print"></i> Imprimir</a><a class="btn btn-secondary" href="<c:url value='/retiroAdicionMateriasJefe/entrada.fautapo'/>"><i class="fa fa-fw fa-lg fa-times-circle"></i> Cancelar</a></div>
                            </div>
                        </section>
                    </div>
                </div>
