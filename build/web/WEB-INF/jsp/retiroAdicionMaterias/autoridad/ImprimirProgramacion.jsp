                    ...
                    <div class="tile">
                        <section class="invoice">
                            ...
                            <div class="row d-print-none mt-2">
                                ...
                                <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print();"><i class="fa fa-print"></i> Imprimir</a><a class="btn btn-secondary" href="<c:url value='/retiroAdicionMaterias/entrada.fautapo'/>"><i class="fa fa-fw fa-lg fa-times-circle"></i> Cancelar</a></div>
                            </div>
                        </section>
                    </div>
                </div>
