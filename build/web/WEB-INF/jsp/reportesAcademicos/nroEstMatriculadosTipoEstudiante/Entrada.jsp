    ...
    <body>
        ...
        <section class="lockscreen-content">
            <div class="lock-box"><img class="rounded-circle user-image" src="${simagen}">
                <h4 class="text-center"><c:out value="${nombres}" /></h4>
                <p class="text-center text-muted">N&uacute;mero de Matriculados por Tipo Estudiante</p>
                <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/nroEstMatriculadosTipoEstudiante/ListarProgramasTipoEstudiante.fautapo">
