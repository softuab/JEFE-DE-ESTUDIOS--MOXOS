                        ...
                        <section class="invoice">
                            ...
                            <div class="row mb-4">
                                <div class="col text-center">
                                    <h2 style="text-align: center;">ESTUDIANTES NO PROGRAMADOS POR CARRERA</h2>
                                </div>
                            </div>
                            <div  class="row invoice-info">
                                ...
                                <div class="col-6">
                                    <address>
                                        <strong>
                                            Facultad:: 
                                        </strong><c:out value="${datosFacultad.facultad}"/>
                                    </address>
                                </div>
                            </div>
                            <div class="row">
                                            ...
                                            <tbody>
                                                <c:forEach var="datos" items="${lEstudiantes}" varStatus="contador">
                                                    <tr>
                                                        ...
                                                        <td data-title="R.U."><c:out value="${datos.id_estudiante}"/></td>
                                                        <td data-title="PATERNO"><c:out value="${datos.paterno}"/></td>
                                                        <td data-title="MATERNO"><c:out value="${datos.materno}"/></td>
                                                        <td data-title="NOMBRES"><c:out value="${datos.nombres}"/></td>
                                                        <td data-title="PLAN"><c:out value="${datos.id_plan}"/></td>        
                                                    <tr>		
                                                    </c:forEach>
                                            </tbody>
                                        </table>
                            ...
                            <div class="row d-print-none mt-2">
                                <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print();"><i class="fa fa-print"></i> Imprimir</a><a class="btn btn-danger" href="<c:url value="/auxiliaresPorPrograma/entrada.fautapo"/>"><i class="fa fa-ban"></i> Cancelar</a></div>
                            </div>
                        </section>
                    </div>
                </div>
