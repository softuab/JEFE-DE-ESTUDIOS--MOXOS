...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-dashboard"></i><i class="far fa-address-card"></i>&nbsp;Imprimir Plan De Estudios</h1>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/planDeEstudios/listarMenciones.fautapo">
                        ...
                        <form method="post" id="frmsalir" modelAttribute="model" action="${pageContext.request.contextPath}/planDeEstudiosVolver/listarProgramasPlanes.fautapo"> 
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
