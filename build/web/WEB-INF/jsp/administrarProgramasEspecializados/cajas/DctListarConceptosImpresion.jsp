...
<table>
  <tr>
    <td colspan="2" align="center"><font size="4"><b>RECIBO Nro. &nbsp; <c:out value="${datosTransaccion.nro_recibo}"/></font></b></td>
  </tr>
</table>
</center>
<br>
<table class="tabla2">
  <tr>
    <th>Nombre</th>
    <td>
      <c:out value="${docente.nombres}"/> <c:out value="${docente.paterno}"/> <c:out value="${docente.materno}"/>
    </td>
