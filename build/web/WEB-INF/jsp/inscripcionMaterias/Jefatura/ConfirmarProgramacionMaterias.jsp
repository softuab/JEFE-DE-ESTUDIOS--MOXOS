                        ...
                        <section class="invoice">
                            ...
                            <div class="row">
                                <div class="col table-responsive">
                                    <form name='forma' method=post action=<c:url value="/inscripcionMaterias/registrarProgramacionMaterias.fautapo"/> >
                                    ...
                                    <form method="post" id="frmsalir" modelAttribute="model" action="${pageContext.request.contextPath}/inscripcionMaterias/listarProgramacionMaterias.fautapo">
                                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                        <input type="hidden" name="gestion" value="<c:out value='${gestion}'/>">
                                        <input type="hidden" name="periodo" value="<c:out value='${periodo}'/>">
                                        <input type="hidden" name="id_tipo_evaluacion" value="<c:out value='${id_tipo_evaluacion}'/>">
