                    ...
                    <div class="tile">
                        <section class="invoice">
                            ...
                            <div class="row invoice-info">
                                <div class="col-4">
                                    <address>
                                        ...
                                        <strong>AULA DESCONCENTRADA:: </strong><c:out value="${datosEstudiante2.sede_desconcentrada}"/><br>
                                    </address>
                                </div>
                                <div class="col-4">
                                    <address>
                            ...
                            <div class="row d-print-none mt-2">
                                <form name="fvolver" action="<c:url value='/inscripcionMateriasAutomatica/comprobarEntrada.fautapo'/>" method="post">
