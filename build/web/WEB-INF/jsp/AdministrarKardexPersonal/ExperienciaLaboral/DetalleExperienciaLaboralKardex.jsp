                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="text-right">
                                                    <div class="btn-group" role="group">
                                                        <form name="descarrgar${detalle.id_experiencia_laboral}" action="<c:url value="./FileDownloadController.fautapo"/>" method="GET">
                                                        ...
                                                        &nbsp;
                                                        <form name="forma"  action="<c:url value="/ModificarExperiencia.fautapo"/>" method="GET">
