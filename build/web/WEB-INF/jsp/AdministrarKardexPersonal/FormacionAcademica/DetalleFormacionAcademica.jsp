    ...
    <body class="app sidebar-mini rtl">
                    ...
                    <div class="col-sm-12">
                        <div class="tile"> 
                            ...
                            <div class="tile-title-w-btn">
                                ...
                                <form name="forma" class="unlock-form" action="<c:url value="/NuevoFormacionAcademica.fautapo"/>" method="POST">     
                                    <input type="hidden" name="id_persona" value='${id_persona}' /> 
                            ...
                            <div class="tile-body">
                                <ul class="list-unstyled" id="listformacion">
                                    <c:forEach var="detalle" items="${formacion}"> 
                                        <li class="media" id="li${detalle.id_formacion}">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p>
                                                    ...
                                                    <div class="toggle-flip">
                                                        <label>
                                                            Desea aprobar el documento? <input type="checkbox" name="chk${detalle.id_formacion}" data-formacion="${detalle.id_formacion}" onclick="actualizaraprobacion(this)" <c:out value="${detalle.aprobado ? 'checked': ''}"/>><span class="flip-indecator" data-toggle-on="SI" data-toggle-off="NO"></span>
                                                        </label>
                                                    </div> 
                                                </c:if>
                                                </p>
                                                <div class="text-right">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        &nbsp;
                                                        <form name="forma"  action="<c:url value="/ModificarFormacionAcademica.fautapo"/>" method="GET">
                                                            <input type="hidden" name="id_formacion" value='${detalle.id_formacion}' />
                                                            <input type="hidden" name="id_persona" value='${id_persona}' />
                                                            <button class="btn btn-primary" type="submit"><i class="fas fa-user-edit"></i></button>
                                                        </form>
                                                        &nbsp; 
                                                        <button class="btn btn-primary" data-formacion="${detalle.id_formacion}" data-name="li${detalle.id_formacion}" onclick="deleteitem(this, 'li${detalle.id_formacion}')" type="submit"><i class="far fa-trash-alt"></i></button>
        ...
        <script>
                                                            function actualizaraprobacion(input) {
                                                                var data = {
                                                                    id_formacion: $(input).data("formacion"),
                                                                    estado: $(input).prop('checked')
                                                                };
                                                                $.get('./ModificarEstadoAprobacionDocumentoFormacionAcademica.fautapo', data, function (data)
                                                                {
                                                                ...
                                                                swal({
                                                                    ...
                                                                    switch (value) {
                                                                        case "Eliminar":
                                                                            ...
                                                                            $.get('./EliminarFormacionAcademica.fautapo', data, function (data)
                                                                            {
                                                                                if (data.status === "success") {
