...
@Controller
public class JefedeEstudioProgramacionController {
    ...
    @RequestMapping(value = "/inscripcionMaterias/entrada.fautapo", method = RequestMethod.GET)
    public String handleRequest(HttpServletRequest request, ModelMap modelo) {
        ...
        return "inscripcionMaterias/Jefatura/Entrada";

    }

    @RequestMapping(value = "/inscripcionMaterias/comprobarEntrada.fautapo", method = RequestMethod.POST)
    public String comprobarEntrada(@ModelAttribute("model") @Validated ParametrosEntrada model, BindingResult result, HttpServletRequest request, ModelMap modelo) {
        ...
        return "inscripcionMaterias/Jefatura/ComprobarEntrada";
    }

    @RequestMapping(value = "/inscripcionMateriasVolver/comprobarEntrada.fautapo", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/inscripcionMaterias/comprobarEntrada1.fautapo", method = RequestMethod.POST)
    public String comprobarEntrada1(HttpServletRequest request, ModelMap modelo) {
        ...
        if ((sId_programa != null) && (sId_tipo_evaluacion != null) && (!"".equals(sId_tipo_evaluacion))) {
            ...
            return "inscripcionMaterias/Jefatura/BuscarEstudiantes";
        }
    ...
    @RequestMapping(value = "/inscripcionMaterias/listarProgramacionMaterias.fautapo", method = RequestMethod.POST)
    public String listarProgramacionMaterias(HttpServletRequest request, ModelMap modelo) {
        ...
        if (!"".equals(sId_estudiante)) {
            ...
            try {
                ...
                return "inscripcionMaterias/Jefatura/Aviso";
            }
            ...
            if (buscarPeriodo != null) {
                ...
                if (lParametros.size() == 0) {
                    ...
                    if (iValor != 1) {
                        ...
                        modelo.addAttribute("periodo", sPeriodo);
                        modelo.addAttribute("gestion", sGestion);
                        return "inscripcionMaterias/Jefatura/ListarProgramacionMaterias";
                    }
                    if (iValor != 0) {
                ...
                List lMateriasEst = this.mi.getEstPrgListarProgramacionMateriasAut(programacionEst);
        ...
        return "inscripcionMaterias/Jefatura/ListarDatosEstudiantes";
    }

    @RequestMapping(value = "/inscripcionMaterias/listarProgramacionMaterias1.fautapo", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/inscripcionMaterias/confirmarProgramacionMateriasJefeEstudio.fautapo", method = RequestMethod.POST)
    public String confirmarProgramacionMaterias(HttpServletRequest request, ModelMap modelo) {
        ...
        if (sValores == null) {
            ...
            return "inscripcionMaterias/Jefatura/AvisoMateria";
        }
        ...
        for (int i = 0; i < sValores.length; i++) {
            if (sValores[i] != null) {
                ...
                try {
                    ...
                    return "inscripcionMaterias/Jefatura/Error";
                }
        ...
        modelo.addAttribute("id_tipo_evaluacion", sId_tipo_evaluacion);
        modelo.addAttribute("nombres", cliente.getNombres());
        return "inscripcionMaterias/Jefatura/ConfirmarProgramacionMaterias";
    }

    @RequestMapping(value = "/inscripcionMaterias/registrarProgramacionMaterias.fautapo", method = RequestMethod.POST)
    public String registrarProgramacionMaterias(HttpServletRequest request, ModelMap modelo) {
        ...
        modelo.addAttribute("usuario", cliente.getNombres());
        return "inscripcionMaterias/Jefatura/ImprimirProgramacion";
    }

    @RequestMapping(value = "/retiroAdicionMateriasJefe/entrada.fautapo", method = RequestMethod.GET)
    public String retiroAdicionMaterias(HttpServletRequest request, ModelMap modelo) {
        ...
        modelo.addAttribute("simagen", this.GetUsuario().getImagen());
        modelo.addAttribute("model", model);
        return "retiroAdicionMaterias/Jefatura/Entrada";
    }

    @RequestMapping(value = "/retiroAdicionMateriasJefe/comprobarEntrada.fautapo", method = RequestMethod.POST)
    public String retiroAdicionMateriasComprobar(@ModelAttribute("model") @Validated ParametrosEntrada model, BindingResult result, HttpServletRequest request, ModelMap modelo) {
        ...
        if ((sId_programa != null) && (sId_tipo_evaluacion != null) && (!"".equals(sId_tipo_evaluacion))) {
            ...
            return "retiroAdicionMaterias/Jefatura/BuscarEstudiantes";
        }
        ...
        return "retiroAdicionMaterias/Jefatura/ComprobarEntrada";
    }

    @RequestMapping(value = "/retiroAdicionMateriasJefe/comprobarEntrada1.fautapo", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/retiroAdicionMateriasJefe/listarAccionProgramacionMaterias.fautapo", method = RequestMethod.POST)
    public String listarAccionProgramacionMaterias(HttpServletRequest request, ModelMap modelo) {
        ...
        if (!"".equals(sId_estudiante)) {
            ...
            try {
                ...
                modelo.addAttribute("mensaje", "El R.U. no es valido, introduzca un numero");
                return "retiroAdicionMaterias/Jefatura/Aviso";
            }
            datosEstudiante.setId_programa(Integer.parseInt(sId_programa));
            datosEstudiante = this.mi.getEstBuscarEstudiantePrograma(datosEstudiante);
            modelo.addAttribute("datosEstudiante", datosEstudiante);
            ...
            modelo.addAttribute("id_periodo", Integer.toString(buscarPeriodo.getId_periodo()));
            modelo.addAttribute("usuario", cliente.getNombres());
            return "retiroAdicionMaterias/Jefatura/RetirarAdicionarCambiarMaterias";
        }
        ...
        if (!"".equals(sCi)) {
            ...
            //this.mi.getEstListarEstudiantesDip
            modelo.addAttribute("lEstudiantes", lEstudiantes);
            return "retiroAdicionMaterias/Jefatura/ListarDatosEstudiantes";
        }
    ...
    @RequestMapping(value = "/retiroAdicionMateriasJefe/listarProgramacionMaterias.fautapo", method = RequestMethod.POST)
    public String listarProgramacionMateriasretiro(HttpServletRequest request, ModelMap modelo) {
        ...
        if (lParametros.size() == 0) {
            ...
            if (iValor1 != 0) {
                if ("Adicion".equals(sAccion)) {
                    ...
                    //modelo.addAttribute("periodo", sPeriodo);
                    modelo.addAttribute("lParametros", lParametros);
                    return "retiroAdicionMaterias/Jefatura/ListarProgramacionMaterias";
                ...
                if ("Retiro".equals(sAccion)) {
                    ...
                    return "retiroAdicionMaterias/Jefatura/ListarRetirarMaterias";
                }
                ...
                if ("Cambio de grupo".equals(sAccion)) {
                    ...
                    return "retiroAdicionMaterias/Jefatura/ListarCambiarGrupoMaterias";
                }
            }
        } else {
            if ("Adicion".equals(sAccion)) {
        ...
        return "retiroAdicionMaterias/Jefatura/ProgramacionMateriasSalida1";
    }

    @RequestMapping(value = "/retiroAdicionMateriasJefe/confirmarAccionProgramacionMaterias.fautapo", method = RequestMethod.POST)
    public String confirmarProgramacionMaterias11(HttpServletRequest request, ModelMap modelo) {
        ...
        if (sValores == null) {
            ...
            modelo.addAttribute("mensaje", "No selecciono ninguna materia");
            modelo.addAttribute("accion", sAccion);
            return "retiroAdicionMaterias/Jefatura/AvisoMateria";
        }
        if ("Retiro".equals(sAccion)) {
            for (int i = 0; i < sValores.length; i++) {
                if (sValores[i] != null) {
            ...
            return "retiroAdicionMaterias/Jefatura/ConfirmarAccionProgramacionMaterias";
        }
    ...
    @RequestMapping(value = "/retiroAdicionMateriasJefe/registrarAccionProgramacionMaterias.fautapo", method = RequestMethod.POST)
    public String RegistrarAccionProgramacionMaterias1(HttpServletRequest request, ModelMap modelo) {
        ...
        if ("Retiro".equals(sAccion)) {
            ...
            if (lMaterias.size() > 0) {
                modelo.addAttribute("lMaterias", lMaterias);
                return "retiroAdicionMaterias/Jefatura/ListarMateriasNoRegistradas";
            }
        }
        ...
        // FIN - DESDE AQUI LA IMPRESION DE LA PROGRAMACION
        return "retiroAdicionMaterias/Jefatura/ImprimirProgramacion";

    }

    @RequestMapping(value = "/reimprimirProgramacionEstudianteJefe.fautapo", method = RequestMethod.GET)
    public String reimprimirProgramacionEstudiante(HttpServletRequest request, ModelMap modelo) {
        ...
        return "reportesAcademicos/reimprimirEstudiantePrograJefatura/Entrada";
    }

    @RequestMapping(value = "/listarReimpresionJefatura.fautapo", method = RequestMethod.POST)
    public String listarReimpresionProgramacionEstudiante(HttpServletRequest request, ModelMap modelo) {
        ...
        if ("No".equals(sTodas)) {
            ...
            if (lProgramacion.size() == 0) {
                ...
                return "reportesAcademicos/reimprimirEstudiantePrograJefatura/Aviso";
            }
        ...
        modelo.addAttribute("nombres", cliente.getNombres());
        return "reportesAcademicos/reimprimirEstudiantePrograJefatura/ListarProgramacion";
    }
