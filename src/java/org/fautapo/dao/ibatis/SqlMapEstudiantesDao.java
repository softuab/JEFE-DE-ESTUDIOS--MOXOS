...
//FIN - METODOS ADICIONADOS POR LA UAP
    ...
    @Override
    public Integer getBuscarCompromisosporCarrera(Estudiantes estudiante) throws DataAccessException {
        return getSqlSession().selectOne("getBuscarCompromisosporCarrera", estudiante);
    }
