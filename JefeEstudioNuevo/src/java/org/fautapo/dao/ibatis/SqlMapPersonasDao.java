...
//FIN - METODOS ADICIONADOS POR LA UAP
    ...
    @Override
    public List<Personas> GetListaPersonasHabilitadas(String buscar) throws DataAccessException {
        return getSqlSession().selectList("GetListaPersonasHabilitadas", buscar);
    }
