...
@Getter
@Setter
@ExisteUsuarioPasswordRecovery(segundo = "apodo", tercero = "tipoUsuario", cuarto = "tipoEncriptacion", quinto = "confirmar_apodo")
@FieldMatch(first = "confirmar_clave", second = "clave", message = "Los campos de la contraseña deben coincidir")
public class UsuarioDocentePasswordRecoveryModel {
    ...
    private String confirmar_apodo;
