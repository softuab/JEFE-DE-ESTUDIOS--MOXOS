...
@Getter
@Setter
@ExisteGrupo(materia = "id_materia", evaluacion = "id_tipo_evaluacion", gestion = "gestion", periodo = "periodo", grupo = "id_grupo", message = "Debe habilitar la Direccion de Planificacion Academica la creacion de grupo")
