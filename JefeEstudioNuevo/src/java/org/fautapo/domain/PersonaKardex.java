...
public class PersonaKardex {
    ...
    public String getImagetituloposgrado() {
        return imagetituloposgrado;
    }

    public void setImagetituloposgrado(String imagetituloposgrado) {
        this.imagetituloposgrado = imagetituloposgrado;
    }
