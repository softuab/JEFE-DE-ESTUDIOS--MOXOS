        ...
        <main class="app-content3">
            <div class="app-title">
                <div>
                    ...
                    <p><c:out value="${datosPrograma.programa}"/> Plan: <c:out value="${id_plan}"/> Gestíon: <c:out value="${datosAsignacion.gestion}"/> Periodo: <c:out value="${datosAsignacion.periodo}"/></p>
                    <p>${usuario}</p>  
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/actaPorFases/ListarActaCalificaciones.fautapo">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <c:out value="${datosAsignacion.materia}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3">Grupo</label>
                                <div class="col-md-8">
                                    <c:out value="${datosAsignacion.grupo}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <form method="post" id="frmsalir" action="${pageContext.request.contextPath}/actaPorFases/ListarDocentesActaCalificaciones.fautapo">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                            <input type="hidden" name="id_programa" value='<c:out value="${id_programa}"/>'>
