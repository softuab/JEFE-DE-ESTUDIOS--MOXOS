...
<html lang="es">
    ...
    <body>
                ...
                <div class="card border-secondary mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body text-secondary">  
                        <p class="card-text text-center"> 
                            ...
                            <a  class="btn btn-primary text-center" href='<c:url value="/reimprimirProgramacionEstudiante.fautapo"/>'"><strong>Volver</strong></a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <script src="<c:url value='/Public/Js/jquery/jquery-3.3.1.min.js'/>" type="text/javascript"></script>
    </body>
</html>