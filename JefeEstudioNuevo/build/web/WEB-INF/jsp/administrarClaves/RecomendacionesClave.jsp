                        ...
                        <div class="Card-Informacion">
                            <div class="card border-secondary mb-3" style="max-width: 18rem;">
                                ...
                                <div class="card-body text-secondary"> 
                                    <form action="<c:url value="/registrarClave.fautapo"/>" method="GET">
                                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                        <p class="card-text"> 
                                            <b><font color="red">Atenci&oacute;n señor(a) Jefe de Estudios :&nbsp;</font></b><c:out value="${nombres}" /><br/>
                                        ...
                                        <div class="text-center"> <input class="btn btn-primary" type=submit value="Siguiente"></div>
                                    </form>
                                </div>
                            </div>
                        </div>
