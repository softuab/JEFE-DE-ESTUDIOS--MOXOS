                    ...
                    <div class="tile">
                        <form  name="forma"  action="<c:url value="/auxiliares/registrarAsignacionAuxiliar.fautapo"/>" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input class="form-control" type="date" name='fec_inicio' id="fec_inicio" />
                                </div>
                                <label class="control-label col-md-1">Fecha Fin</label>
                                <div class="col-md-4">
                                    <input class="form-control" type="date" name="fec_fin" id="fec_fin"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input  class="form-control" type="date" name='fec_resolucion' id="fec_resolucion"/>  
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3">Carga Horaria</label>
                                <div class="col-md-8">
                                    <input  class="form-control" type="number" name='carga_horaria' id="carga_horaria">
                                </div>
                            </div>
                            <div class="form-group row">
