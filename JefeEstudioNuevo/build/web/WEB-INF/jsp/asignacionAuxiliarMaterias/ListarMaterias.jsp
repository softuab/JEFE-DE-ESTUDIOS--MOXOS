                                            ...
                                            <c:if test="${listado1.nro_grupos > 0}">
                                                <c:forEach var="lista" items="${listado1.grupos}" >                                                       
                                                    <c:if test="${lista.id_asignacion == 0}">
                                                        ...
                                                        <form name="fnuevo<c:out value='${lista.id_dpto_grupo}'/>" action='<c:url value='/auxiliares/nuevoAsignacionAuxiliar.fautapo'/>' method="post">
                                                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                                            <input type="hidden" name="id_dpto_grupo" value="<c:out value='${lista.id_dpto_grupo}'/>">
                                                            <input type="hidden" name="id_asignacion" value="<c:out value='${lista.id_asignacion}'/>">
                                                            <input type="hidden" name="id_prg_plan"   value="<c:out value='${datosPrgPlan.id_prg_plan}'/>">
                                                    ...
                                                    <c:if test="${lista.id_asignacion != 0}">
                                                        ...
                                                        <form id="modificar" name="fmodificar<c:out value='${lista.id_dpto_grupo}'/>" action="<c:url value='/auxiliares/modificarAsignacionAuxiliar.fautapo'/>" method="post">
                                                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                                            <input type="hidden" name="id_dpto_grupo"  value="<c:out value='${lista.id_dpto_grupo}'/>">
                                                            <input type="hidden" name="id_asignacion"  value="<c:out value='${lista.id_asignacion}'/>">
                                                            <input type="hidden" name="id_prg_plan"    value="<c:out value='${datosPrgPlan.id_prg_plan}'/>">
                                                        ...
                                                        <form name="feliminar<c:out value='${lista.id_dpto_grupo}'/>" action="<c:url value='/auxiliares/nuevoAsignacionAuxiliar.fautapo'/>" method="post">
                                                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                                            <input type="hidden" name="id_dpto_grupo"  value="<c:out value='${lista.id_dpto_grupo}'/>">
                                                            <input type="hidden" name="id_asignacion"  value="<c:out value='${lista.id_asignacion}'/>">
                                                            <input type="hidden" name="id_prg_plan"    value="<c:out value='${datosPrgPlan.id_prg_plan}'/>">
