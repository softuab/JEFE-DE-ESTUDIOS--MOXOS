    ...
    <body>
        ...
        <section class="lockscreen-content">
            <div class="lock-box">
                ...
                <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/bucarEstudiantes/comprobarEntrada.fautapo">
                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                    <div class="form-group">
                        <form:password cssClass="form-control" path="clave" placeholder="Introduzca su contraseña" />
