                        ...
                        <section class="invoice">
                            ...
                            <div class="row">
                                <div class="col table-responsive">
                                    <form name='forma' method="post" action=<c:url value="/retiroAdicionMaterias/confirmarAccionProgramacionMaterias.fautapo"/> >
                                    ...
                                    <form method="post" id="frmsalir" action="${pageContext.request.contextPath}/retiroAdicionMaterias/listarAccionProgramacionMaterias.fautapo">
                                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
