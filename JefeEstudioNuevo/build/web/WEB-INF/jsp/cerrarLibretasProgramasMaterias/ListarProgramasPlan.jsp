...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="far fa-address-card"></i>&nbsp; Cerrar Libretas Programa Materia</h1>
                    <p>${usuario}</p>  
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form name='forma' class="form-horizontal" method="post" action='<c:url value='/cerrarLibretasProgramasMaterias/listarMateriasProgramaPlan.fautapo'/>'>
                                    ...
                                    <div class="col-md-8">
                                        <select name="id_prg_plan" class="form-control" id="id_prg_plan" required>
                                            ...
                                            <c:forEach var="plan" items="${acceso.listaPlanes}" varStatus="pln">
                                                <option value="<c:out value="${plan.id_plan}"/>-<c:out value="${plan.id_prg_plan}"/>"><c:out value="${plan.id_plan}"/> - <c:out value="${plan.tipo_grado}"/></option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        <button class="btn btn-primary" type='submit' value='Siguiente'><i class="fa fa-fw fa-lg fa-check-circle"></i>Siguiente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="<c:url value='/cerrarLibretasProgramasMaterias/entrada.fautapo'/>"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
