                    ...
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/${ruta}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <form:input path="confirmar_apodo" cssClass="form-control" />
                                    <form:errors path="confirmar_apodo" cssClass="invalid"/>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        <button class="btn btn-primary" type='submit' value='Siguiente'><i class="fa fa-fw fa-lg fa-check-circle"></i>Siguiente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="${pageContext.request.contextPath}/docente/retornarlistarUsuarios.fautapo?status=alert-danger&message=Se cancelo los cambios del usuario ${model.nombre_completo}" id="btnsalir" ><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form:form>
