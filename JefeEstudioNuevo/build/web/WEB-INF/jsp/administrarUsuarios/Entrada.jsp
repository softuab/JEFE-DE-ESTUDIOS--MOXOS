    ...
    <body> 
        ...
        <section class="lockscreen-content">
            <div class="lock-box">
                ...
                <p class="text-center text-muted">Administrar Usuarios</p>
                <form:form method="get" modelAttribute="model" action="${pageContext.request.contextPath}/usuarios/listarUsuarios.fautapo">
