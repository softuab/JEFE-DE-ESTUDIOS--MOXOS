                    ...
                    <div class="Card-Informacion">
                        <div class="card border-secondary mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body text-secondary">  
                                <p class="card-text">Desea Eliminar este usuario ${model.accion}?</p>
                                <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/${ruta}"> 
                                    ...
                                    <button class="btn btn-primary" type='submit' value='Siguiente'><i class="fa fa-fw fa-lg fa-check-circle"></i>Siguiente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="${pageContext.request.contextPath}/usuarios/retornarlistarUsuarios.fautapo?status=alert-danger&message=Se cancelo la elimnacion del usuario ${model.accion}" id="btnsalir" ><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                </form:form>
                            </div>
                        </div>
                    </div>
