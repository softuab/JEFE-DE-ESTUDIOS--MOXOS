...
<html lang="es">
    <head> 
        ...
        <link href="stylesheet" href="<c:url value='/Public/Css/bootstrap.min.css'/>" type="text/css"/>
                            ...
                            <c:if test="${fn:length(datos)>0}">
                                <div class="row md-4">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <h5 class="text-right" width="30%;">Fecha :<fmt:formatDate value="${today}" pattern="${formatoFecha}"/></a> </h5>
                                    </div>
                                </div>
                                <hr>
                                <div class="row md-4">
                                ...
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print();"><i class="fa fa-print"></i> Imprimir</a><a class="btn btn-danger" href="<c:url value="/estadisticaEspecializada/promedioNotas/listarCondiciones.fautapo"/>"><i class="fa fa-ban"></i> Cancelar</a></div>
                                </div>
                            </c:if>
                            <c:if test="${fn:length(datos)==0}">
                                <div class="container">
                                        ...
                                        <div class="card border-secondary mb-3" style="max-width: 18rem;">
                                            ...
                                            <div class="card-body text-secondary">
                                                <p class="card-text text-center">
                                                    ...
                                                    <a class="btn btn-primary text-center" href="#" id="btnsalir" ><strong>Volver</strong></a>
                                                </p>
                                                <form method="post" id="frmsalir" modelAttribute="modal" action="${pageContext.request.contextPath}/estadisticaEspecializada/promedioNotas/listarCondicionesVolver.fautapo">
                                                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                                </form>
                                            </div>
                                        </div>
