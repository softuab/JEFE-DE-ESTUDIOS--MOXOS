...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="far fa-address-card"></i>&nbsp;Estudiantes con la mayor nota</h1>
                    <p>${usuario}</p>
                </div>
            </div> 
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form modelAttribute="forma" cssClass="form-horizontal" method="post" action="${pageContext.request.contextPath}/estadisticaEspecializada/mayorNota/formarReporte.fautapo">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <c:if test="${1 > cliente.id_programa}">
                                        <select id="id_programa" name="id_programa" disabled="true"  required onchange="setCargarPlanes(this.options[this.selectedIndex].value)">
                                            <option value="-1">Elija una opci&oacute;n...</option>
                                        </select>
                                    </c:if>
