                        ...
                        <section class="invoice">
                            ...
                            <c:if test="${fn:length(datos)>0}">
                                ...
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print();"><i class="fa fa-print"></i> Imprimir</a><a class="btn btn-danger" href="<c:url value="/estadisticaEspecializada/rendimientoNivel/listarCondiciones.fautapo"/>"><i class="fa fa-ban"></i> Cancelar</a></div>
                                </div>
                            </c:if>
                            <c:if test="${fn:length(datos)==0}">
                                <div class="container">
                                    <div class="Card-Informacion">
                                        <div class="card border-secondary mb-3" style="max-width: 18rem;">
                                            ...
                                            <div class="card-body text-secondary">
                                                ...
                                                <form method="post" id="frmsalir" modelAttribute="modal" action="${pageContext.request.contextPath}/estadisticaEspecializada/rendimientoNivel/listarCondicionesVolver.fautapo">
                                                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
