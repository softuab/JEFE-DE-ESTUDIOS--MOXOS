...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-dashboard"></i><i class="far fa-address-card"></i>&nbsp;Administrar Usuarios - Estudiantes</h1>
                    <p>${usuario}</p>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/${ruta}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <form:input type="email"  path="correo" cssClass="form-control" />
                                    <form:errors path="correo" cssClass="invalid"/>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        <button class="btn btn-primary" type='submit' value='Siguiente'><i class="fa fa-fw fa-lg fa-check-circle"></i>Siguiente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="${pageContext.request.contextPath}/estudiante/retornarlistarUsuarios.fautapo?status=alert-danger&message=Se cancelo el registro del usuario ${model.nombre_completo}" id="btnsalir" ><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form:form>
