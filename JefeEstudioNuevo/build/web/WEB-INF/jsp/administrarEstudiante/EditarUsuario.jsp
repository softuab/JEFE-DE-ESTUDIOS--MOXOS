                    ...
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/${ruta}">
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-3">Nombre usuario<span class="text-danger">*</span></label>
                                <div class="col-md-9">
                                    <form:input path="nombre_completo" readonly="true" cssClass="form-control" />
                                    <form:errors path="nombre_completo" cssClass="invalid"/>
                                </div>
                            </div> 
                            <div class="form-group row">
                                <label class="control-label col-md-3">Correo o Nombre usuario<span class="text-danger">*</span></label>
                                <div class="col-md-9">
                                    <form:input path="confirmar_correo" cssClass="form-control" />
                                    <form:errors path="confirmar_correo" cssClass="invalid"/>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-3">Celular<span class="text-danger">*</span></label>
                                <div class="col-md-9">
                                    <form:input path="celular" cssClass="form-control" />
                                    <form:errors path="celular" cssClass="invalid"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3">Observacion</label>
                                <div class="col-md-9">
                                    <form:input path="observacion" cssClass="form-control" />
                                    <form:errors path="observacion" cssClass="invalid"/>
                                </div>
                            </div>
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        <button class="btn btn-primary" type='submit' value='Siguiente'><i class="fa fa-fw fa-lg fa-check-circle"></i>Siguiente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="${pageContext.request.contextPath}/estudiante/retornarlistarUsuarios.fautapo?status=alert-danger&message=Se cancelo los cambios del usuario ${model.nombre_completo}" id="btnsalir" ><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form:form>
