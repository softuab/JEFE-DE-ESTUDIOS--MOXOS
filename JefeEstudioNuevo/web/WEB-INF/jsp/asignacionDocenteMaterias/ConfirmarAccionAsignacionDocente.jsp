...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-dashboard"></i><i class="far fa-address-card"></i>&nbsp;Asignaci&oacute;n Docente Materias</h1>
                    <p>Programa: <c:out value="${programa.programa}"/> Plan: <c:out value="${datosPrgPlan.id_plan}"/> Gestión: <c:out value="${gestion}"/>  Periodo: <c:out value="${periodo}"/> Materia: <c:out value="${materia.materia}"/> Grupo: <c:out value="${datosDptoGrupo.grupo}"/> Tipo de Evaluación: <c:out value="${datosDptoGrupo.tipo_evaluacion}"/> </p>
                    <p></p>
                </div>
            </div>
            <div  class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form  name=forma  action="<c:url value="/docentes/registrarAsignacionDocente.fautapo"/>" method=post>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <h6>Confirmar&nbsp;<c:out value="${accion}"/>&nbsp;Asignaci&oacute;n </h6> 
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <c:if test="${datosAsignacion.id_fase > 0}"> <font color="red"><blink><br> Antes de Eliminar, tenga encuenta que el docente esta<br>en una fase avanzada.</blink> </font></c:if>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-3">H.C.C.</label>
                                <div class="col-md-8">
                                    <c:out value="${datosAsignacion.nro_resolucionhcc}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3">H.C.F.</label>
                                <div  class="col-md-8">
                                    <c:out value="${datosAsignacion.nro_resolucionhcf}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3">H.C.U.</label>
                                <div  class="col-md-8">
