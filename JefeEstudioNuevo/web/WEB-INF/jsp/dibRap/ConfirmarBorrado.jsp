...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-dashboard"></i>Eliminando <c:out value="${tabla.etiqueta}" /></h1>
                    <p>${usuario}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        ...
                        <form method="post" id="frmsalir" action="${pageContext.request.contextPath}/dibRap/listarDatos.fautapo">
