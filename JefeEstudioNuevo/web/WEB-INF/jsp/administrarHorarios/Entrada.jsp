    ...
    <body>
        ...
        <section class="lockscreen-content">
            <div class="lock-box"><img class="rounded-circle user-image" src="${simagen}">
                ...
                <p class="text-center text-muted">Administrar Horarios</p>
                <form action="<c:url value="/administrarHorarios/listarProgramasPlanes.fautapo"/>"  method="post">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="Password" name="clave" placeholder="Introduzca su contraseña" autofocus>
                    </div>
