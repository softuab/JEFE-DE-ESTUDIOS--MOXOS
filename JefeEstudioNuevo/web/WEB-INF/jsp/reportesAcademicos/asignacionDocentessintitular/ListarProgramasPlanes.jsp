...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="far fa-address-card"></i>&nbsp;Ver Asignaci&oacute;n Docentes</h1>
                    <p>${usuario}</p>  
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/asignacionDocentessintitular/ListarDocentesMaterias.fautapo">
                                    ...
                                    <div class="col-md-8">
                                        <select name="id_plan" id="id_plan"  class="form-control" required>
                                            ...
                                            <c:forEach var="plan" items="${acceso.listaPlanes}" varStatus="pln">
                                                <option value="<c:out value="${plan.id_plan}"/>" ><c:out value="${plan.tipo_grado}"/> - <c:out value="${plan.id_plan}"/></option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" name="id_tipo_evaluacion" required>
                                        <option value=""> - Elija una opción - </option>    
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        <button class="btn btn-primary" type='submit' value='Siguiente'><i class="fa fa-fw fa-lg fa-check-circle"></i>Siguiente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="<c:url value='/asignacionDocentessintitular/verAsignacionDocentes.fautapo'/>"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form:form>
