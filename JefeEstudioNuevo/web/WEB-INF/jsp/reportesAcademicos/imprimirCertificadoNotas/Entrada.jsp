    ...
    <body>
        ...
        <section class="lockscreen-content">
            <div class="lock-box"><img class="rounded-circle user-image" src="${simagen}">
                ...
                <p class="text-center text-muted">Imprimir Certificado de Notas</p>
                <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/imprimirCertificadoNotas/listarProgramasPlanes.fautapo">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <label class="input-group-text">Nro. Certificado</label>
                            <input class="form-control" type="text" name="nrocertificado" placeholder="Nro. Certificado" required>
                        </div>
                    </div>
