                        ...
                        <section class="invoice">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-3">
                                    ...
                                    <h5 class="text-right">Fecha : <fmt:formatDate value="${today}" pattern="${formatoFecha}"/></h5>
                                </div>
                            </div>
                            <hr>
                            <div class="row mb-4">
                            ...
                            <div class="row mb-4">
                                <div class="col-6">
                                    <address>
                                        ...
                                        <strong>Tipo Estudiante:: </strong> ESTUDIANTE NUEVO
                                    </address>
                                </div>
                                <div class="col-6">
                                    <address>
                                            ...
                                            <tbody>
                                                <c:forEach var="lista" items="${lEstudiantes}" varStatus="contador">
                                                    <tr>
                                                        ...
                                                        <td data-title="Tipo Admision"><c:out value="${lista.tipo_admision}"/></td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
                            ...
                            <div class="row d-print-none mt-2">
                                <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print();"><i class="fa fa-print"></i>Imprimir</a><a class="btn btn-danger" href="<c:url value="/matriculadosPorProgramaTipoEstudiante/entrada.fautapo"/>"><i class="fa fa-ban"></i>Cancelar</a></div>
                            </div>
                        </section>
                    </div>
                </div>
