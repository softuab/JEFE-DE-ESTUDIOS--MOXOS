                    ...
                    <div class="tile">
                        <section class="invoice">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="table-responsive" id="no-more-tables">
                                        <table class="table table-striped table" border="1" cf>
                                            <thead class="cf">
                                                <tr>
                                                    <th>NRO</th>
                                                    <th>CI</th>
                                            ...
                                            <tbody>
                                                <c:forEach var="nroasignacion" items="${lNroAsignacionDocentesMateria}" varStatus="contador2">
                                                    <tr <c:if test="${(contador2.count mod 2) == 0}"></c:if> >

                                                            <td data-title="NRO."rowspan = "${nroasignacion.nro_designacion}"><c:out value="${contador2.count}"/></td>

                                                        <td data-title="CI" rowspan = "${nroasignacion.nro_designacion}"><c:out value="${nroasignacion.dip}"/></td>
                                                        <td data-title="PATERNO" rowspan = "${nroasignacion.nro_designacion}"><c:out value="${nroasignacion.paterno}"/></td>
                                                        <td data-title="MATERNO" rowspan = "${nroasignacion.nro_designacion}"><c:out value="${nroasignacion.materno}"/></td>
                                                        <td data-title="NOMBRES" rowspan = "${nroasignacion.nro_designacion}"><c:out value="${nroasignacion.nombres}"/></td>
                                                        <td data-title="FUNCION" rowspan = "${nroasignacion.nro_designacion}"><c:out value="${nroasignacion.descripcion}"/></td>
                                                        ...
                                                        <c:if test="${(nroasignacion.nro_designacion) <= 1}"> 
                                                            ...
                                                            <td data-title="DEDICACION" rowspan = "${nroasignacion.nro_designacion}"><c:out value="${nroasignacion.tipo_asignacion}"/></td>  	
                                                        <tr>
                                                        </c:if>
                                                    </c:forEach>  
                                            </tbody>
                            ...
                            <div class="row d-print-none mt-2">
                                <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print();"><i class="fa fa-print"></i> Imprimir</a><a class="btn btn-danger" href="<c:url value="/asignacionDocentesxid/verAsignacionDocentes.fautapo"/>"><i class="fa fa-ban"></i> Cancelar</a></div>
                            </div> 
                        </section>
                    </div>
                </div>
