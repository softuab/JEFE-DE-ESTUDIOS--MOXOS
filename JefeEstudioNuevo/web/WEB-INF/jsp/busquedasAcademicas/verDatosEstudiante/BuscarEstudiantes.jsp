    ...
    <body>
        ...
        <section class="lockscreen-content">
            <div class="lock-box"><img class="rounded-circle user-image" src="${simagen}">
                ...
                <p class="text-center text-muted">Ver Datos de Estudiantes</p>
                <form name=forma method="POST" action="<c:url value="/mostrarDatos.fautapo"/>">
                    ...
                    <div class="input-group">
                        ...
                        <select class="custom-select" name="tipobusqueda" id="tipobusqueda">
                            <option value="id_estudiante">Registro Univeristario</option>
                            <option value="ci">Cedula Identidad</option>
                            <option value="nombres">Nombre Completo</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <input class="form-control" type="text" name="buscar" placeholder="Buscar Estudiante" autofocus required>
                    </div>
