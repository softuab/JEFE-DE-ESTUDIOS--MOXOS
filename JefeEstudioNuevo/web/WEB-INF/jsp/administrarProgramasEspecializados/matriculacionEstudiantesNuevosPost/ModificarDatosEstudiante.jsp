...
<form name="fvolver" action="<c:url value='/estudianteNuevoPost/listarEstudiantes.fautapo'/>" method="post">
  ...
  <input type="hidden" name="id_tipo_admision"  value="<c:out value='${id_tipo_admision}'/>">
  <input type="hidden" name="ru"                value="<c:out value='${ru}'/>">
  <input type="hidden" name="nombre"            value="<c:out value='${nombre}'/>">
  <div> <a class="volver" href="javascript:document.fvolver.submit();"> Volver</a> </div>
</form>
<br>
<form  name=forma action="<c:url value="/estudianteNuevoPost/registrarModificarPersonaEstudiante.fautapo"/>" method="POST">
  <table class="formulario">
    <tr>
      <th colspan="2"> MODIFICAR LOS DATOS </th>
    </tr>  
    <tr>
