                    ...
                    <div class="tile">
                        <section class="invoice">
                            <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/convalidacionManual/confirmarMateriasConvalidar.fautapo">
                                ...
                                <input type="hidden" name="id_facultad" value='<c:out value="${datosEstudiante.id_programa}"/>' >
                                <input type="hidden" id="id_programa" name="id_programa" value="<c:out value='${datosEstudiante.id_programa}'/>">
                                ...
                                <div class="row invoice-info">
                                    <div class="col-12">
                                        ...
                                        <c:if test="${buscarTipoConv.id_tipo_convalidacion ==2}" >
                                            ...
                                            <div class="form-group row">
                                                <label for="id_facultad" class="control-label col-3"><strong>PROGRAMA</strong></label>
