                                ...
                                <div class="col-6">
                                    <address>
                                        ...
                                        <c:forEach var="parametro" items="${lParametros}" >
                                            <c:out value="${parametro.tipo_programacion}"/>
                                        </c:forEach><br>
                                        <strong>TIPO EVALUACIÓN:: </strong><c:out value="${datosTipoEval.tipo_evaluacion}"/><br>
                                        <strong>GESTION:: </strong><c:out value="${gestion}"/><br>
                                        <strong>PERIODO:: </strong><c:out value="${periodo}"/>
                                    </address>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <form method="post" name="formulario" action=<c:url value="/inscripcionMaterias/confirmarProgramacionMaterias.fautapo"/> >
                                        ...
                                        <input type="hidden" name="id_programa" vallue="<c:out value='${id_programa}'/>">
                                    ...
                                    <form method="post" id="frmsalir" modelAttribute="model" action="${pageContext.request.contextPath}/retiroAdicionMaterias/comprobarEntrada1.fautapo">
                                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                        <input type=hidden name="id_periodo"    value=<c:out value="${id_periodo}"/> >
                                      <!--  <input type=hidden name="id_estudiante" value=<c:out value="${datosEstudiante.id_estudiante}"/> > -->
                                        <input type=hidden name="gestion"       value='<c:out value="${gestion}"/>' >
