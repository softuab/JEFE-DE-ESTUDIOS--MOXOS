                ...
                <div class="col-sm-12">
                    <div class="tile"> 
                        <section class="invoice">
                            ...
                            <div class="row">
                                <div class="col">
                                    <form method="post" name="formulario" action=<c:url value="/inscripcionMaterias/confirmarProgramacionMateriasJefeEstudio.fautapo"/> >
                                    ...
                                    <form method="post" id="frmsalir" modelAttribute="model" action="${pageContext.request.contextPath}/inscripcionMaterias/comprobarEntrada1.fautapo">
                                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                        <input type="hidden" name="gestion" value="<c:out value='${gestion}'/>">
                                        <input type="hidden" name="periodo" value="<c:out value='${periodo}'/>">
