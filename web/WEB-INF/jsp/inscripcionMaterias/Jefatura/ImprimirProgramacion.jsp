                        ...
                        <section class="invoice">
                            ...
                            <div class="row mb-4">
                                <div class="col text-center">
                                    <h3 style="text-align: center;">PROGRAMACION DE MATERIAS</h3>
                            ...
                            <div class="row">
                                <div class="col">
                                            ...
                                            <tbody>
                                                <c:forEach var="lista" items="${lProgramacion}" varStatus="contador">
                                                    <tr>
                                                        ...
                                                        <td data-title="HORA"><fmt:formatDate value="${lista.fec_modificacion}" pattern="${formatoHora}"/></td>
                                    ...
                                    <p><strong>Usuario:</strong> &nbsp; [<c:out value="${cliente.nombres}"/>]</p>
                                </div>
                            </div>
                            <div class="row d-print-none mt-2">
                                ...
                                <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print();"><i class="fa fa-print"></i> Imprimir</a><a class="btn btn-danger" href='<c:url value="/inscripcionMaterias/entrada.fautapo"/>'><i class="fa fa-ban"></i> Cancelar</a></div>
                            </div>
                        </section>
                    </div>
                </div>
