    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/inscripcionMateriasAutomatica/comprobarEntrada1.fautapo">
                            ...
                            <c:if test="${fn:length(acceso.listaFacultades) > 0}">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="id_facultad" id="id_facultad" onChange="poblar(this.name, this.options[this.selectedIndex].value)"></select>
                                    </div>
                                </div>
                            </c:if>
                            <c:if test="${fn:length(acceso.listaProgramas) > 0}">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="id_programa" id="id_programa" onChange="poblar(this.name, this.options[this.selectedIndex].value)"></select>
                                    </div>
                                </div>
                            </c:if>
                            <div class="form-group row">
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        <button class="btn btn-primary" type='submit' value='Siguiente'><i class="fa fa-fw fa-lg fa-check-circle"></i>Siguiente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="<c:url value='/inscripcionMateriasAutomatica/entrada.fautapo'/>"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form:form>
