    ...
    <body> 
        ...
        <section class="lockscreen-content">
            <div class="lock-box">
                ...
                <p class="text-center text-muted">Administrar Dpto Grupos</p>
                <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/grupos/listarFacultades.fautapo">
