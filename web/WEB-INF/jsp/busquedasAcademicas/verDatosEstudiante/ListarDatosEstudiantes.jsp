...
<html lang="es">
    ...
    <body>
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-dashboard"></i><i class="far fa-address-card"></i>&nbsp;Ver Datos Estudiantes</h1>
                    <p>${usuario}</p>
                                ...
                                <tbody>
                                    <c:forEach var="datos" items="${lEstudiantes}" varStatus="contador">
                                        <tr <c:if test="${(contador.count mod 2) == 0}"></c:if>>
                                            ...
                                            <td>
                                                <form name=forma<c:out value="${contador.count}"/> method="POST" action="<c:url value="/mostrarDatos1.fautapo"/>">
