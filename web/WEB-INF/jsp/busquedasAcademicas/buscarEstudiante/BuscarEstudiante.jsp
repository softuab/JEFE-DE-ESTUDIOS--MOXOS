...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="far fa-address-card"></i>&nbsp;Buscar Estudiante</h1>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        ...
                        <form method="post" id="frmsalir" action="${pageContext.request.contextPath}/bucarEstudiantesVolver/comprobarEntrada.fautapo">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
