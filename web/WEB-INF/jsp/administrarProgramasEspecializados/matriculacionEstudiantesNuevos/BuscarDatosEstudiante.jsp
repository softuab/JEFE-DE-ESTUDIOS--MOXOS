...
<form name="fvolver" action="<c:url value='/estudianteNuevo/listarPostulantes.fautapo'/>" method="post">
...
<br>
<form  name=forma action="<c:url value="/estudianteNuevo/registrarPrsEstAdmisionEspecial.fautapo"/>" method="POST">
  <input type="hidden" name="gestion" value="<c:out value='${gestion}'/>">
  <input type="hidden" name="periodo" value="<c:out value='${periodo}'/>">
  <table class="formulario">
    <tr>
      <th colspan="2"> INTRODUZCA LOS DATOS DE ESTUDIANTE DE AMDISION ESPECIAL</th>
    </tr>  
    <tr>
    ...
    <tr>
      <td>
        <table class="tabla">
	      ...
	      <input type="text" name="paterno" size="20" title="Apellido Paterno"  style="background-color:pink" onkeyup="fmayus();" value="<c:out value='${datosPrs.paterno}'/>"readonly />
	    </td>	
	   <td class="etiqueta3">2do. Apellido<br>
	        <input type="text" name="materno" size="20" title="Apellido Materno" style="background-color:pink" onkeyup="fmayus();"  value="<c:out value='${datosPrs.materno}'/>"readonly />
	   </td>	
	   <td class="etiqueta3">Nombres <font color="red" >(*)</font></<br>
	       <input type="text" name="nombres" size="20" title="Nombres"  style="background-color:pink" onkeyup="fmayus();"  value="<c:out value='${datosPrs.nombres}'/>"readonly />
	   </td> 
	  </tr>   
	  <tr> 
	    <td class="etiqueta3"> 
	        <label><font size="1px" color="#003366"><b>DIP <font color="red" >(*)</font> </b></font><br></label>
		 <input type="text"  name="dip" title="DIP" style="background-color:pink" size="10" value="<c:out value='${datosPrs.dip}'/>" readonly />
	    </td>
	  ...
	  <tr> 
		...
		<input type="text"  name="correo"  value="<c:out value='${datosPrs.correo}'/>" title="correo" size="20">
	    </td>
	  </tr> 
	  <tr> 
	    <td class="etiqueta3"> Celular<br> 
		 <input type="text"  name="celular" value="<c:out value='${datosPrs.celular}'/>"  title="Nro.Celular"  size="10" >
	    </td>
	    ...
	    <td class="etiqueta3"> 
	        Grupo Sanguineo<br> 
		 <input type="text"  name="tipo_sanguineo"  title="Grupo Sanguineo"  value="<c:out value="${datosPrs.tipo_sanguineo}"/>" size="10"/>
	    </td>
	  </tr> 
	  <tr>
	  ...
	  <tr>
          ...
          <tr >
	       ...
	       <select id = 'id_tipo_institucion' name = 'id_tipo_institucion' size = '1'
            ...
            <script>
               ...
               padre_hijo[h] = new Array ("id_tipo_institucion", "''", "<c:out value = "${bEstColegio.id_tipo_institucion}"/>");
               combo[h] = new Array();
               combo[h][0] = new Array("0", "- Elija una opcion -", "");
	    ...
	    <td class="etiqueta3"> Colegio <font color="red" >(*)</font> <br>
            ...
            <script>
              ...
              padre_hijo[h] = new Array ("id_colegio", "id_tipo_institucion", "<c:out value = "${bEstColegio.id_colegio}"/>");
              combo[h] = new Array();
              combo[h][0] = new Array("0", "- Elija una opcion -", "");
	      ...
	      <select id = 'id_tipo_turno' name = 'id_tipo_turno' size = '1'
            ...
            <script>
              ...
              padre_hijo[h] = new Array ("id_tipo_turno", "''", "<c:out value = "${bEstColegio.id_tipo_turno}"/>");
              combo[h] = new Array();
              combo[h][0] = new Array("0", "- Elija una opcion -", "");
	  ...
	  <tr> 
	    <td class="etiqueta3">A&ntilde;o de Bachiller<font color="red" >(*)</font> </b></font><br> 
	     <input type="text"  name="anio_titulacion"  title="Anio Egreso" size="4" maxlength="4" value="<c:out value='${datosPrs.anio_titulacion}'/>">
	    </td>
		<td>
		</td>
		 <td class="etiqueta3"> 
     ...
     <th colspan="3"> 
	  ...
	  <tr> 
	    <td class="etiqueta3">Titulo Adquirido<br> 
	      <input type="text"  name="titulo"  title="" size="40" value="<c:out value="${datosPrs.titulo}"/>">
	    </td>
 	   <td class="etiqueta3">Universidad<br> 
		 <input type="text"  name="nro_seguro_medico"   title="Nro. Seguro Medico" size="40" value="<c:out value="${datosPrs.nro_seguro_medico}"/>">
	   </td>
	   <td class="etiqueta3"> 
	   </td>
	  <tr>
	...
	<tr>
	  <td class="etiqueta4">Tipo Admision <font color="red">Nuevo (*)</font> </td> 
	...
	<tr>
          ...
          <tr>
            ...
            <script>
                ...
                padre_hijo[h] = new Array ("id_programa", "id_facultad", "");
                combo[h] = new Array();
                combo[h][0] = new Array("0", "- Elija una opcion -", "");
...
<script language="JavaScript">
  ...
  function fguardar()
  {
    if((document.forma.id_persona.value!=0) && (document.forma.id_prg_plan.value!=0) && (document.forma.id_facultad.value!=0) && (document.forma.id_facultad.value!="")
       && (document.forma.id_programa.value!=0) && (document.forma.id_programa.value!="") && (document.forma.id_programa.value!=-1)  && (document.forma.id_prg_plan.value!=-1)
       && (document.forma.nombres.value!="") && (document.forma.dip.value!="") && (document.forma.direccion.value!="") && (document.forma.fec_nacimiento.value!="") &&
