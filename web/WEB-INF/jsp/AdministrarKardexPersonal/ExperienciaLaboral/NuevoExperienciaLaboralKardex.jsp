                ...
                <div class="row"> 
                    <div class="col-sm-12">
                        <div class="tile">
                            ...
                            <form name="forma"  class="form-horizontal" action="<c:url value="/RegistrarPersonaExperienciaKardex.fautapo"/>" method="POST"  enctype="multipart/form-data">     
                                <input type="hidden" name="id_persona" value='${id_persona}' /> 
                                <input type="hidden" name="id_persona_kardex" value='${detalles.id_persona_kardex}' /> 
                                <input type="hidden" name="UUID" value='${detalles.UUID}' /> 
