                                                ...
                                                <tr>
                                                        ...
                                                        <td data-title="ACCION">
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <form name='formaEvaluaciones<c:out value="${contador.count}"/>' method='post' action="<c:url value='/DefinirEvaluacion.fautapo'/>">
                                                                        <a class="dropdown-item" href='javascript:document.formaEvaluaciones<c:out value="${contador.count}"/>.submit();'>Definir evaluaci&oacute;n</a>
                                                                    ...
                                                                    <form name='formaLibretas<c:out value="${contador.count}"/>' method='post' action='<c:url value="/ListarEstudiantesProgramados.fautapo"/>'>
                                                                        <a class="dropdown-item" href='javascript:document.formaLibretas<c:out value="${contador.count}"/>.submit();'>Administrar libretas</a>
                                                                        <input type=hidden name="id_asignacion"      value="<c:out value="${asignacion.id_asignacion}"/>"> 
                                                                        <input type=hidden name="id_materia"         value="<c:out value="${asignacion.id_materia}"/>"> 
                                                                        <input type=hidden name="materia"            value="<c:out value="${asignacion.materia}"/>">
                                                                        <input type=hidden name="id_grupo"           value="<c:out value="${asignacion.id_grupo}"/>">
                                                                    ...
                                                                    <form name='formaFases<c:out value="${contador.count}"/>' method=post action='<c:url value="/avanzarFase.fautapo"/>'>
                                                                        <a class="dropdown-item" href='javascript:document.formaFases<c:out value="${contador.count}"/>.submit();'>Avanzar fase</a>
                                                                        <input type=hidden name="id_asignacion"      value="<c:out value="${asignacion.id_asignacion}"/>"> 
                                                                        <input type=hidden name="id_materia"         value="<c:out value="${asignacion.id_materia}"/>"> 
                                                                        <input type=hidden name="materia"            value="<c:out value="${asignacion.materia}"/>">
                                                                        <input type=hidden name="id_grupo"           value="<c:out value="${asignacion.id_grupo}"/>">
                                                        ...
                                                        <td data-title="ACCION">
                                                            <div class="dropdown">
                                                                <button type="button" class="btn btn-danger btn-sm dropdown-toggle" data-toggle="dropdown">
                                                                    <font size="1">Libreta Cerrada </font>
                                                                </button>
                                                            </div>
                                                    ...
                                                    <c:if test="${asignacion.id_fase =='1000'}">
                                                        <td data-title="ACCION">
                                                            <div class="dropdown">
                                                                <button type="button" class="btn btn-danger btn-sm dropdown-toggle" data-toggle="dropdown">
                                                                    <font  size="1" >Libreta Pre-Cerrada </font>
                                                                </button>
                                                            </div>
                                                        </td>
                                                    </c:if>
