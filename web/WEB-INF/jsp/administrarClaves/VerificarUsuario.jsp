    ...
    <body> 
        ...
        <section class="lockscreen-content">
            <div class="lock-box"><img class="rounded-circle user-image" src="${simagen}">
                ...
                <p class="text-center text-muted">Cambio clave(PIN) Administrativo</p>
                <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/verificarUsuario.fautapo">
                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                    <form:hidden path="boton" />
                    <div class="form-group">
                        <form:password path="clave" cssClass="form-control" placeholder="Introduzca su contraseña" />
