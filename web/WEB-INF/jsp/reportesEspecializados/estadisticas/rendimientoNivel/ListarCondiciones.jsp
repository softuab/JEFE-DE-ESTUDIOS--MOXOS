...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="far fa-address-card"></i>&nbsp;Rendimiento Acad&eacute;mico, por Nivel y Programa</h1>
                    <p>${usuario}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form modelAttribute="forma" cssClass="form-horizontal" method="post" action="${pageContext.request.contextPath}/estadisticaEspecializada/rendimientoNivel/formarReporte.fautapo">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Nivel Acad&eacute;mico</label>
                                    <div class="col-md-8">
                                    <form:input path="nivel_academico"  cssClass="form-control"/>
                                    <form:errors path="nivel_academico" cssClass="invalid"/>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        <button class="btn btn-primary" type='submit' value='Aceptar'><i class="fa fa-fw fa-lg fa-check-circle"></i>Siguiente</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="<c:url value='/VerCuerpo.fautapo'/>"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form:form>
