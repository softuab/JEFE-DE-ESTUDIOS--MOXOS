                        ...
                        <section class="invoice">
                            ...
                            <div class="row mb-4">
                                <div class="col text-center">
                                    <h3 style="text-align: center;">Nro. DE MATRICULADOS POR SEXO Y TIPO ESTUDIANTE</h3>
                                    ...
                                    <div id="no-more-tables">
                                        <table class="table table-striped" border="1" cf>
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="lEstudiante" items="${lEstudiantes}" varStatus="contador">
                                                    <tr>
                                                        ...
                                                        <td data-title="NUEVO"><c:out value="${lEstudiante.reprobados}"/></td>
                                                        <td data-title="ANTIGUO"><c:out value="${lEstudiante.cantidad-lEstudiante.reprobados}"/></td>	  
                                                        <td data-title="TOTAL FEMENINO" class="colb" ><c:out value="${lEstudiante.cantidad}"/></td>	  
                                                        <td data-title="NUEVO"><c:out value="${lEstudiante.abandonos}"/></td>	  
                                                        <td data-title="ANTIGUO"><c:out value="${lEstudiante.aprobados-lEstudiante.abandonos}"/></td>		   
                                                        <td data-title="TOTAL MASCULINO" class="colb"><c:out value="${lEstudiante.aprobados}"/></td>	  
                                            ...
                                            <tr>
                                                ...
                                                <td data-title="ANTIGUO"class="colb"><c:out value="${cont1}"/></td>   
                                                <td data-title="TOTAL FEMENINO"class="colb"><c:out value="${cont2}"/></td>   
                                                <td data-title="NUEVO" class="colb"><c:out value="${cont3}"/></td>   
                                                <td data-title="ANTIGUO"class="colb"><c:out value="${cont4}"/></td>  
                                                <td data-title="TOTAL MASCULINO"class="colb"><c:out value="${cont5}"/></td>   			
                                            </tr>  
                                            <tr>
                            ...
                            <div class="row d-print-none mt-2">
                                <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print();"><i class="fa fa-print"></i> Imprimir</a><a class="btn btn-danger" href="<c:url value="/nroEstMatriculadosSexo/Entrada.fautapo"/>"><i class="fa fa-ban"></i> Cancelar</a></div>
                            </div>
                        </section>
                    </div>
                </div>
