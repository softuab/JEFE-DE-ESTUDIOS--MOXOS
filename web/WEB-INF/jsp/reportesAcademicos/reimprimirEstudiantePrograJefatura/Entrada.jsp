    ...
    <body>
        ...
        <section class="lockscreen-content">
            <div class="lock-box"><img class="rounded-circle user-image" src="${simagen}">
                ...
                <p class="text-center text-muted">Reimprimir Programacion</p>
                <form name="forma" action="<c:url value="/listarReimpresionJefatura.fautapo"/>" method="POST">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <label class="input-group-text">Imprimir</label>
                        </div>
                        <select class="custom-select" name="todas" id="tipobusqueda">
                            <option value="No"> Regular/Mesa de Examen</option>
                            <option value="Si">Curso de Verano</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <input class="form-control" type="text" name="id_estudiante" placeholder="Registro Universitario" autofocus required>
                    </div>
