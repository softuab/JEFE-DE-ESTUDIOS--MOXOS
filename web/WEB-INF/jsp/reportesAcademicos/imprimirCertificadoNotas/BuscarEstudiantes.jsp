    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <div>
                        <h1><i class="far fa-address-card"></i> Imprimir Certificado de Notas</h1>
                        <p>Gestión: <c:out value='${gestion}'/> Periodo: <c:out value='${periodo}'/> Programa: <c:out value='${datosPrograma.programa}'/></p>
                        <p>Nº Certificado:: <c:out value='${nrocertificado}'/> Observación:: <c:out value='${observacion}'/></p>
                        <p>${usuario}</p>  
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/imprimirCertificadoNotas/listarCertificadoNotas.fautapo">
                        ...
                        <form method="post" id="frmsalir" action="${pageContext.request.contextPath}/imprimirCertificadoNotasVol/listarProgramasPlanes.fautapo">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
