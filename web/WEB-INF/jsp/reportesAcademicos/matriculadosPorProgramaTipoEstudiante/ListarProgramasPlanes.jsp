...
<html lang="es">
    ...
    <body class="app sidebar-mini">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="far fa-address-card"></i>&nbsp;Estudiantes Matriculados Por Programa, Tipo Estudiante</h1>
                    <p>${usuario}</p> 
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form method="post" modelAttribute="model" action="${pageContext.request.contextPath}/matriculadosPorProgramaTipoEstudiante/listarEstudiantes.fautapo">
                            ...
                            <c:if test="${lista.id_estudiante > 0}"><input type="hidden" name="id_estudiante" value='<c:out value="${lista.id_estudiante}"/>'></c:if>
